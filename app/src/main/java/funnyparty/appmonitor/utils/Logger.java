    ...
    public static void log(int level, String logMsg) {
        ...
        switch (level) {
            case LEVEL_VERBOSE:    // verbose
                Log.d(Globle.LOG_TAG, logMsg);
                Log.d(Globle.LOG_TAG, callRef);
                break;
            case LEVEL_LOW:    // debug - low
                Log.i(Globle.LOG_TAG, logMsg);
                Log.i(Globle.LOG_TAG, callRef);
                break;
            case LEVEL_MID:    // info - middle
                Log.w(Globle.LOG_TAG, logMsg);
                Log.w(Globle.LOG_TAG, callRef);
                break;
            case LEVEL_HIGH:    // warn - high
                Log.e(Globle.LOG_TAG, logMsg);
                Log.e(Globle.LOG_TAG, callRef);
                break;
            default:
                Log.v(Globle.LOG_TAG, logMsg);
                Log.v(Globle.LOG_TAG, callRef);
        }
    }
