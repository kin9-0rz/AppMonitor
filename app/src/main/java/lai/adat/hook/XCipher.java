...
public class XCipher extends MethodHook {
    ...
    private XCipher(Methods method) {
    ...
    public static List<MethodHook> getMethodHookList() {
        ...
        methodHookList.add(new XCipher(Methods.doFinal));
    ...
    private ArrayList<byte[]> extractData(byte[] bytes) {
        ...
        while (byteCount > 0) {
            int targetDataLen = byteCount > Global.DATA_BYTES_TO_LOG / 2 ? Global.DATA_BYTES_TO_LOG / 2 : byteCount;
